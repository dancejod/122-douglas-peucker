...
def create_figure(graph1_x, graph1_y, graph2_x, graph2_y):
    ...
    ax1.plot(graph1_x, graph1_y, "-ok", color = "black", markersize = 5, markerfacecolor = "white")
    ax1.set_title("Raw line; number of vertices: {}".format(len(rawline)))
    ax1.set(xlabel = "x-axis", ylabel = "y-axis")
    ax1.get_xaxis().set_visible(False)
    ax1.get_yaxis().set_visible(False)
    ax2.plot(graph2_x, graph2_y, "-ok", color = "black", markersize = 5, markerfacecolor = "white")
